...
namespace OpenTKLib
{
    ...
    public static class ColorExtensions
    {
        ...
        public static System.Drawing.Color FromdoublesRGB(this System.Drawing.Color color, double r, double g, double b)
        {
        ...
        /// <param name="mat">The desired transformation</param>
        /// <returns>The transformed vector</returns>
        public static System.Drawing.Color FromDoubleARGB(this System.Drawing.Color color, double a, double r, double g, double b)
        {
            byte ra = Convert.ToByte(a * byte.MaxValue);
            byte ri = Convert.ToByte(r * byte.MaxValue);
            byte rg = Convert.ToByte(g * byte.MaxValue);
        ...
        public static double[] ToDoubles(this System.Drawing.Color color)
        {
            double[] myColorF = new double[4];
